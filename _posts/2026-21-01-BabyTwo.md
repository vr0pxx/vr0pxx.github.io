...
tags: [Windows, Vulnlab, WriteUp, Medium, AD, RID-Cycling, Password-Spray, SMB, SYSVOL, Bloodhound, GenericAll, GPO-Abuse, WriteOwner, WriteDacl, PowerView, pygpoabuse]
...
![BloodHound GPOADM]({{ '/assets/img/posts/vl/babytwo/bloodhound-gpoadm.png' | relative_url }}){: .center-image }
...
![GPO ID]({{ '/assets/img/posts/vl/babytwo/gpo-id.png' | relative_url }}){: .center-image }
